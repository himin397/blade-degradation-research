"""
02_run_turbsim.py
Phase 5b: TurbSim を40ケース分並列実行して .bts ファイルを生成する
"""
...
WIND_DIR   = SCRIPT_DIR.parent / "wind"
TURBSIM_BIN = "/opt/anaconda3/envs/blade-phase3/bin/TurbSim"

inp_files = sorted(WIND_DIR.glob("*.inp"))
print(f"Found {len(inp_files)} TurbSim input files")
...
if __name__ == "__main__":
    print("Running TurbSim (max_workers=4)...")
    results = []
