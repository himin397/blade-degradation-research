"""
04_run_openfast.py
Phase 5b: OpenFAST 40ケースを並列実行する
各ケース約600秒シミュレーション → M1 Mac (8スレッド) で max_workers=4 を推奨
"""
...
print(f"Found {len(case_dirs)} OpenFAST cases")
...
if __name__ == "__main__":
    print("Running OpenFAST (max_workers=4)... This will take ~20-40 minutes total.")
    t_start = time.time()
    results = []
